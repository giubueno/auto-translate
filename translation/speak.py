...
def speak(input_file_path, language="es", voice="echo"):
    ...
    with open(input_file_path, 'r', encoding='utf-8') as file:
        ...
        with client.audio.speech.with_streaming_response.create(
            ...
            speech_file_path = Path(__file__).parent / f"{output_path}/{os.path.basename(file.name)}.mp3"
...
# Andy Wood
# python speak.py -f ./inputs/texts/de/00:01 -l de -v echo
# python speak.py -f ./inputs/texts/de/00:49 -l de -v echo
# python speak.py -f ./inputs/texts/de/01:22 -l de -v echo

# Buddy Owens
# python speak.py -f ./inputs/texts/de/01:22 -l de -v onyx

# python speak.py -f ./inputs/texts/es/00:01 -l es -v echo
# python speak.py -f ./inputs/texts/es/00:49 -l es -v echo
# python speak.py -f ./inputs/texts/es/01:22 -l es -v echo
